...
function estimateReadTime(body: string): number {
  return Math.max(1, Math.ceil(body.length / 1000))
}
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-24 pb-8">
        ...
        <div className="bento-cell rounded-xl p-12 text-center">
          <p className="text-sm text-text-muted font-mono">No posts yet.</p>
        </div>
      </div>
    )
  }
        ...
        {posts.map((post, i) => (
          ...
          >
            ...
            >
              ...
              <div className="text-[11px] text-text-muted leading-relaxed mb-4 line-clamp-3 prose-excerpt">
                {post.excerpt ? (
