    ...
    <footer className="py-6 mt-auto transition-colors duration-300" style={{
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          {/* Left - Build info and copyright (centered on mobile) */}
          <div className="flex flex-col items-center md:items-start space-y-2 md:flex-1">
            <div className="flex items-center gap-1.5 font-mono text-sm font-medium" style={{ color: isDarkMode ? themeColors.colors.white : themeColors.colors.pink[700] }}>
              <span className="w-2 h-2 rounded-full bg-emerald-400 inline-block" />
              <span>Built with React & TypeScript</span>
            </div>
            <div className="text-sm" style={{ color: isDarkMode ? themeColors.colors.white : themeColors.colors.pink[700] }}>
              © {currentYear} Makiaveloh. All rights reserved.
            </div>
          </div>
